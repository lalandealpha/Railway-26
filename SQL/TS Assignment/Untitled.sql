...
insert into Car_order (OrderID, CustomerID, CarID, Amount, SalePrice, OrderDate, DeliveryDate, DeliveryAddress, `Status`, Note) values (43, 6, 31, 3, 3247422349, '2021-07-05', '2021-09-30', '00 Mallard Road', '1', null);
...
insert into Car_order (OrderID, CustomerID, CarID, Amount, SalePrice, OrderDate, DeliveryDate, DeliveryAddress, `Status`, Note) values (45, 4, 21, 1, 1203410041, '2021-06-01', '2021-10-14', '18 Bunting Avenue', '0', 'Cl skl w oth fx-mod coma');
...
insert into Car_order (OrderID, CustomerID, CarID, Amount, SalePrice, OrderDate, DeliveryDate, DeliveryAddress, `Status`, Note) values (50, 1, 48, 2, 1064638394, '2021-08-03', '2021-11-23', '24 Atwood Parkway', '1', null);
...
BEGIN
	...
	JOIN Car_Order co
	ON c.CarID = co.CarID
	WHERE c.CarID IN	(SELECT co.CarID
						FROM Car_Order co
						GROUP BY co.CarID

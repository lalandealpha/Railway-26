				...
				while (isCorrect2) {
					...
					if (shn) {
						if (Integer.parseInt(ageInput1) > 0) {
							Engineer engineer = new Engineer(fullNameInput1, Integer.parseInt(ageInput1), null,
									addressInput1, specialityInput1);
				...
				while (isCorrect3) {
					...
					if (shn) {
						if (Integer.parseInt(ageInput2) > 0) {
							Employee employee = new Employee(fullNameInput2, Integer.parseInt(ageInput2), null,
									addressInput2, jobInput);
							...
							while (isCorrect5) {
								...
								if (shn2) {
									if (Integer.parseInt(levelInput) > 0 && Integer.parseInt(levelInput) < 11) {
										Worker worker = new Worker(fullNameInput3, Integer.parseInt(ageInput3), null,
												addressInput3, Integer.parseInt(levelInput));

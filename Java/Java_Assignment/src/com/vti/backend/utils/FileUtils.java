...
public class FileUtils {
	...
	public static void createNewFile(String folderPath, String fileName) throws Exception {
	...
	public static String[] getAllFileName(String folderPath) throws Exception {
	...
	public static void copyFile(String fileToCopy, String destPath) throws Exception {
	...
	public static void copyFile(String fileToCopy, String folderPath, String newName) throws Exception {
		File file1 = new File(fileToCopy);
	...
	public static void moveFile(String fileToMove, String newFilePath) throws Exception {
	...
	public static void renameFile(String fileToRename, String newNamePath) throws Exception {
	...
	public static void createNewFolder(String newFolderPath) throws Exception {
	...
	public static void downloadFile(String filePath, String urlString) throws Exception {
		File file = new File(filePath);
		if(!file.exists()) {

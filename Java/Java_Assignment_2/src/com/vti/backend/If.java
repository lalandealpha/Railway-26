...
public class If {
	...
	Student student1, student2, student3, student4, student5, student6, student7, student8, student9, student10, student11;
	...
	public If() {
		...
		teacher2 = new Teacher(2, "ldawbury1@telegraph.co.uk", "ldawbury1", "Lorilee Dawbury", Gender.MALE,
				department1, LocalDate.of(2021, 3, 22));
		teacher3 = new Teacher(3, "lesilmon2@indiegogo.com", "lesilmon2", "Lila Esilmon", Gender.MALE,
				department1, LocalDate.of(2019, 5, 19));
		teacher4 = new Teacher(4, "nagresswell3@godaddy.com", "agresswell3", "Axe Gresswell", Gender.MALE,
				department2, LocalDate.of(2018, 7, 25));
		teacher5 = new Teacher(5, "bscotson4@plala.or.jp", "bscotson4", "Brig Scotson", Gender.UNKNOWN,
	...
	public void Question3() {
		...
		String i;
		i = (teacher1.getDepartment() == null)
				? "Ms. " + teacher1.getFullName() + "  has not been assigned to any department yet."
				: "Ms. " + teacher1.getFullName() + "'s department is: " + teacher1.getDepartment() + ".";
	...
	public void Question4() {
		...
		if (student1.getPosition() == null) {
			...
			String checkPosition = (student1.getPosition().equals(Pos.ADMIN)) ? student1.getFullName() + " is an admin."
					: student1.getFullName() + " is not an admin.";

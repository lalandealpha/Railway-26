...
public class If {
	...
	public void Question1() { // Question 1: Check if teacher1 is assigned to any department or not, and print
		...
		// Question 1: Check if teacher1 is assigned to any department or not, and print
		// the corresponding output
	...
	public void Question2() { // Question 2: Check how many students there are in class5 and print the
		...
		// Question 2: Check how many students there are in class5 and print the
		// corresponding output
		System.out.println("\n" + "Question 2: ");
	...
	public void Question4() { // Question 4: Use the ternary operator.
		...
		checkPosition = (student1.getPosition().equals(Pos.ADMIN)) ? student1.getFullName() + " is an admin."

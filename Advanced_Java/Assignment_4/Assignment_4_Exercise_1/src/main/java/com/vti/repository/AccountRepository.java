...
//    }
    ...
    public AccountDTO getEmpAndManagerAmount() {
        ...
        try {
            ...
            Query<Long> empQuery = session.createQuery("SELECT COUNT(1) FROM Employee");
            Query<Long> managerQuery = session.createQuery("SELECT COUNT(1) FROM Manager");

            Long employeeAmount = empQuery.uniqueResult();
            Long managerAmount = managerQuery.uniqueResult();
            AccountDTO accountDTO = new AccountDTO(employeeAmount, managerAmount);

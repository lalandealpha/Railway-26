...
public class HibernateUtils {
	...
	private void configure() {
		...
		configuration.configure("TestingSystemHibernate.cfg.xml");
		...
		configuration.addAnnotatedClass(PositionNameConverter.class);
		configuration.addAnnotatedClass(Question.class);
		configuration.addAnnotatedClass(Salary.class);
		configuration.addAnnotatedClass(SalaryNameConverter.class);
		configuration.addAnnotatedClass(TypeNameConverter.class);
